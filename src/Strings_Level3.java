public class Strings_Level3 {
	/*
	 * Problem #1 Given a string, return true if the first instance of "x" in the
	...
	/*
	 * Problem #2 Given a string, return a string made of the chars at indexes 0,1,
	...
	/*
	 * Problem #3 Count the number of "xx" in the given string. We'll say that
	...
	/*
	 * Problem #4 Given a string, return a version where all the "x" have been
	...
	/*
	 * Problem #5 Suppose the string "yak" is unlucky. Given a string, return a
	...
	/*
	 * Problem #6 Given an array of ints, return true if it contains a 2, 7, 1
	...
	/*
	 * Problem #7 We'll say that a String is xy-balanced if for all the 'x' chars in
	 * the string, there exists a 'y' char somewhere later in the string. So "xxy"
	 * is balanced, but "xyx" is not. One 'y' can balance multiple 'x's. Return true
	...
	/*
	 * Problem #8 Given two strings, a and b, create a bigger string made of the
	...
	/*
	 * Problem #9 Given a string and an int n, return a string made of the first n
	...
	/*
	 * Problem #10 Given two strings, word and a separator sep, return a big string
	...
	/*
	 * Problem #11 Given a string, does "xyz" appear in the middle of the string? To
	 * define middle, we'll say that the number of chars to the left and right of
	...
	/*
	 * Problem #12 A sandwich is two pieces of bread with something in between.
	...
	/*
	 * Problem #13 Given a string, compute a new string by moving the first char to
	...
	/*
	 * Problem #14 Look for patterns like "zip" and "zap" in the string -- length-3,
	...
	/*
	 * Problem #15 Given a string and a non-empty word string, return a version of

...
public class Recursion_Level1 {
	...
	/*
	 * Problem#1 Given base and n that are both 1 or more, compute recursively (no
	 * loops) the value of base to the n power, so powerN(3, 2) is 9 (3 squared).
	 * 
	 * powerN(3, 1) → 3 
	 * powerN(3, 2) → 9 
	 * powerN(3, 3) → 27
	...
	/*
	 * Problem #2 Given a string, compute recursively (no loops) the number of
	...
	/*
	 * Problem #3 Given a string, compute recursively (no loops) the number of times
	...
	/*
	 * Problem #4 We have triangle made of blocks. The topmost row has 1 block, the
	...
	/*
	 * Problem #5 Given a non-negative int n, return the sum of its digits
	...
	/*
	 * Problem #6 Given a string, compute recursively (no loops) a new string where
	...
	/*
	 * Problem #8 Given an array of ints, compute recursively if the array contains
	 * a 6. We'll use the convention of considering only the part of the array that
	...
	/*
	 * Problem #9 Given an array of ints, compute recursively the number of times
	...
	/*
	 * Problem #10 Given an array of ints, compute recursively if the array contains
	 * somewhere a value followed in the array by that value times 10. We'll use the
	 * convention of considering only the part of the array that begins at the given
	...
	/*
	 * Problem #11 Given a string, compute recursively a new string where all the
	...
	/*
	 * Problem #12 Given a string, compute recursively a new string where identical
	...
	/*
	 * Problem #13 Given a string, compute recursively a new string where all the
	...
	/*
	 * Problem #14 We'll say that a "pair" in a string is two instances of a char
	...
	/*
	 * Problem #15 Count recursively the total number of "abc" and "aba" substrings
	...
	/*
	 * Problem #16 Given a string, compute recursively (no loops) the number of "11"
	...
	/*
	 * Problem #17 Given a string, return recursively a "cleaned" string where
	...
	/*
	 * Problem #18 Given a string, compute recursively the number of times lowercase
	 * "hi" appears in the string, however do not count "hi" that have an 'x'
	...
	/*
	 * Problem #19 -----> My solution works just fine. However, there is a much
	 * simpler solution to this problem provided by the website. Given a string that
	 * contains a single pair of parenthesis, compute recursively a new string made
	 * of only of the parenthesis and their contents, so "xyz(abc)123" yields
	 * "(abc)".
	 * 
	...
	/*
	 * Problem #19 Given a string, compute recursively (no loops) a new string where
	...
	/*
	 * Problem #20 Given a non-negative int n, compute recursively (no loops) the
	...
	/*
	 * Problem #21 Given a string, return true if it is a nesting of zero or more
	...
	/*
	 * Problem #22 Given a string and a non-empty substring sub, compute recursively
	 * the number of times that sub appears in the string, without the sub strings
	 * overlapping.
	 * 
	...
	/*
	 * Problem #23 Given a string and a non-empty substring sub, compute recursively
	...
	/*
	 * Problem #24 Given a string and a non-empty substring sub, compute recursively
